...
void add_matrices(int matrix_1[][100],int matrix_2[][100],int row_1,int col_1,int sum_matrix[][100])
{
...
void display_result(int sum_matrix[][100],int row_1,int col_1)
{
    for(int i=0;i<row_1;i++)
    {
        for(int j=0;j<col_1;j++)
...
int main()
{
    ...
    {
        cout<<"Error . Matrix cannot be added. Rows and Columns must be equal"<<endl;
    }
    ...
    else
    {
        ...
        add_matrices(matrix_1,matrix_2,row_1,col_1,sum_matrix);

        cout<<"The sum matrix is : "<<endl;
        display_result(sum_matrix,row_1,col_1);
    }
